...
#ps.make_wav(song[:100], fn='C:/Users/hyunju/Desktop/temp/third.wav')
...
random_song = []
for i in range(0, 100): #100개의 노트를 만들겠다는 것
...
make_midi(midi_path='C:/Users/hyunju/Desktop/temp/morenote.mid', notes=random_song)
